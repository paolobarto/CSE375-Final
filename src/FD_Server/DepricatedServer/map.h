...
public:
  ...
  virtual bool insert(K key, V val, std::function<void()> on_success) = 0;
  ...
  ///         otherwise
  virtual bool do_with(K key, std::function<void(V &)> f, std::function<void()> on_success) = 0;
  ...
  /// @return true if the key existed and the function was applied, false
  ///         otherwise
  virtual bool do_with_readonly(K key, std::function<void(const V &)> f, std::function<void()> on_success) = 0;
  ...
  virtual bool remove(K key, std::function<void()> on_success) = 0;
